...
Our experiments also do confirm that there is no sensitivity loss in going from the \dBCM to the \dBHT in the sense that nearly all ($99.5\%$) real \kmers are still queried and visited in the traversal in all tested scenarios.\paguso{confirmar que é isso mesmo}
